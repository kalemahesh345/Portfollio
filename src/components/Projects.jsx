...
const projectList = [
  ...
  {
    title: 'AI-Powered Automated Job Search & HR Outreach Agent',
    description: 'An AI-powered job automation agent that discovers relevant jobs, analyzes and matches them with the candidate’s profile and skills, finds HR contacts, stores opportunities in Google Sheets, and automates personalized email outreach with status tracking.',
    tags: ['n8n', 'Google Gemini', 'Job Automation', 'Profile Matching', 'Google Sheets', 'Ai Agent', 'Conversational Memory', 'API Integration', 'Email Automation', 'HR Outreach',],
    github: 'https://github.com/kalemahesh345/N8N-Workflow/blob/main/gmail%20wk1.json',
    demo: 'http://localhost:5678/workflow/FgI7L5zL7TTNOZUL',
    workflowImage: '/workflows/job-search-agent-workflow.png',
    gradient: 'from-accent-600/40 via-accent-700/10 to-transparent',
    borderColor: 'group-hover:border-accent-500/30',
    glowColor: 'rgba(166, 131, 78, 0.15)',
    category: 'AI Agent'
